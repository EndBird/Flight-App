...
public class FlightManager {
    ...
    private static FlightsGraph sFlightsGraph;
    ...
    public static FlightsGraph getFlightsGraph() {
        if (sFlightsGraph == null)
            sFlightsGraph = new FlightsGraph(new ArrayList<Flight>());
        return sFlightsGraph;
    }
     ...
     * date and which contain available seats.
     *
    ...
    public static void saveFlights() {
        DataManager.getInstance().saveFlights(
                new ArrayList<>(getFlightsGraph().getFlights()));
    }
